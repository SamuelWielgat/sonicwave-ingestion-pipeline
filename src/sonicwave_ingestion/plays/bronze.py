"""plays Bronze: source column list and snapshot run function."""
...
# All columns the plays source drop carries — all land as strings in Bronze.
...
def run(
    ...
    """Land one plays snapshot drop into Bronze.
